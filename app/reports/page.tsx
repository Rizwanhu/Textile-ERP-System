...
export default function ReportsPage() {
  ...
  const expensePie = [
    { name: "Local Supplier", value: totals.buyer },
    ...
    <div className="mx-auto animate-fade-in space-y-6 p-4 lg:p-6" style={{ maxWidth: 1440 }}>
      ...
      <Tabs defaultValue="orders" className="space-y-4">
            ...
            <ResponsiveContainer>
              <LineChart data={monthlyRevenue}>
                ...
                <Tooltip
                  ...
                  formatter={(value) => formatPKR(typeof value === "number" ? value : Number(value ?? 0))}
                />
        ...
        <TabsContent value="expenses" className="grid gap-4 lg:grid-cols-3">
          ...
          <ChartCard title="Top suppliers" subtitle="Local Supplier purchases" className="lg:col-span-2">
            <ResponsiveContainer>
