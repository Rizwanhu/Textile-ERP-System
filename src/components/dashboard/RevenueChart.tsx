      ...
      <div className="h-60 w-full">
        <ResponsiveContainer>
          <AreaChart data={data} margin={{ top: 4, right: 8, left: -16, bottom: 0 }}>
            ...
            <YAxis tick={{ fill: "hsl(var(--muted-foreground))", fontSize: 12 }} axisLine={false} tickLine={false} tickFormatter={(v) => `Rs ${(v / 1_000_000).toFixed(1)}M`} />
            <Tooltip
              contentStyle={{
            ...
            <Area type="monotone" dataKey="expenses" stroke="hsl(var(--violet))"  strokeWidth={2} fill="url(#exp)" />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
