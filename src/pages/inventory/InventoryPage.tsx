...
import {
  INVENTORY, STOCK_HISTORY, stockTone, stockStatusLabel, inventoryValue,
...
export default function InventoryPage() {
  ...
  const handleAdd = (it: InventoryItem) => setItems((prev) => [it, ...prev]);
            ...
            <div className="overflow-x-auto">
              <Table>
                ...
                <TableBody>
                  ...
                  {filtered.length === 0 && (
                    <TableRow><TableCell colSpan={9} className="py-12 text-center text-sm text-muted-foreground">No items match your filters.</TableCell></TableRow>
                  )}
                </TableBody>
              </Table>
            </div>
          ...
          <section className="overflow-hidden rounded-xl border border-border bg-card shadow-card">
            <header className="flex items-center justify-between border-b border-border px-6 py-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground">{STOCK_HISTORY.length} recent events across all SKUs</p>
              </div>
            </header>
            <div className="overflow-x-auto">
              <Table>
